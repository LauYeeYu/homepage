...
you can specify the remote repository by running:
...
directory you want to ignore. To pattern applies to the directory of the
...
| `git fetch` | Fetch changes from the remote repo | Use `git fetch <url>` if you want to fetch any non-default branch |
